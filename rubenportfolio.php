...
<main>
  ...
  <div class="wrap">
    ...
    <section class="text-box bracket" aria-label="Over Ruben">
      ...
      <p>Ik bouw websites en webapplicaties die helder zijn voor bezoekers en prettig blijven werken voor de mensen die ze beheren.</p>
      <p>Mijn focus ligt op een sterke technische basis met HTML, CSS, PHP en MySQL. Van de eerste structuur tot de laatste controle zorg ik voor overzichtelijke code en een betrouwbare gebruikerservaring.</p>
    </section>
