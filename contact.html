...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  /* ---------- PAGE ---------- */
  main{position:relative; flex:1; display:flex; align-items:center; padding:90px 0;}
  ...
  .contact-card{
    position:relative; padding:28px; background:var(--white);
    border:1px solid var(--line);
  }
  .contact-card h2{font-size:25px; margin-bottom:6px;}
  .contact-card p{color:var(--steel); margin-bottom:18px;}
  .contact-details{display:flex; flex-direction:column; gap:8px; font-size:15px;}
  .contact-details a{color:var(--blue); font-weight:500; overflow-wrap:anywhere;}
  .contact-details a:hover{text-decoration:underline;}
  .contact-label{font-size:11px; color:var(--steel); text-transform:uppercase;}
