...
<body>
  ...
  <main>
    ...
    <div class="wrap" style="position:relative; z-index:2;">
      ...
      <p class="team-intro">Vijf mensen, een gedeelde liefde voor technisch werk dat helder, snel en betrouwbaar
        aanvoelt.</p>
      <div class="team-grid">
        ...
        <article class="person-card bracket">
          ...
          <a class="person-link" href="rayportfolio.php">portfolio &rarr;</a>
        </article>
        <article class="person-card bracket">
