...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .bracket::before, .bracket::after{
    ...
    border-color:var(--blue); border-style:solid; opacity:0.55;
  }
  ...
  /* ---------- PAGE ---------- */
  main{position:relative; flex:1; padding:90px 0 110px; overflow:hidden;}
  .page-head{padding:40px; max-width:640px; margin:0 auto;}
  ...
  .person-card .role{font-size:12px; color:var(--blue); text-transform:uppercase; font-weight:600; letter-spacing:.05em;}
  .person-card p{font-size:14px; color:#4A525C; margin-top:16px;}
  .person-card .person-link{margin-top:auto; padding-top:22px; color:var(--blue); font-size:12px; font-weight:600; text-transform:uppercase; letter-spacing:.06em;}
  .person-card .person-link:hover{color:var(--ink);}
